...
const BeforeLogin = () => {
  return (
    <Form>
      <Form.Item>
        <Link to="/login">
          <Button type="primary" id="homelogin" size="large">
            登录
          </Button>
        </Link>
      </Form.Item>
      <Form.Item>
        <Link to="/register">
          <Button type="primary" id="homeregister" size="large">
            注册
          </Button>
        </Link>
      </Form.Item>
      <Form.Item>
        <Link to="/preview/books">
          <Button type="primary" id="homepreview" size="large">
            随便逛逛吧
          </Button>
        </Link>
      </Form.Item>
...
const items = [
  getItem("图书管理", "sub1", <BookOutlined />, [
    getItem(<Link to="/preview/books">图书列表</Link>, "g1"),
    getItem(<Link to="/preview/hotRanking">热门排行</Link>, "g2"),
  ]),
];
    ...
    <>
      <Layout className="mainpage">
        <Header className="header">
          <Title level={3} type="success" className="wetitle">
            图书管理系统
          </Title>
          <LoginRegisterButton />
        </Header>
                  ...
                  <Card
                    ...
                    cover={
                      <img
                        alt="example"
                        src={
                          "http://127.0.0.1:5000/images/" + item.isbn + ".jpg"
                        }
                      />
                    }
                    actions={[
...
const FakeBorrowCollect = (props) => {
  ...
  return (
    <>
      <Space>
        <Button onClick={handleCilck} type={buttontype}>
          {name}
        </Button>
      </Space>
    </>
